...
To ensure you provide the appropriate Auth0 configuration as expressed in the values.yaml, be certain to reference the collatoral that contained your docker registry credentials. Contact your Qualytics account manager for assistance.
